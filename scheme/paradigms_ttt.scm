...
(define-public onegametree (lambda () (list (list 'x 'o 'x 'o 'o 'e 'e 'x 'e)	;; x value = 0
			  ;; node 1, child of root
			  (list (list 'x 'o 'x 'o 'o 'x 'e 'x 'e) ;; x value = +10
				    ;; node 4, child of node 1
				    (list (list 'x 'o 'x 'o 'o 'x 'o 'x 'e)	;; x value = +10
					      ;; node 10, child of node 4
					      (list (list 'x 'o 'x 'o 'o 'x 'o 'x 'x)	;; x value = +10
					      ) ;; end of node 10
				    ) ;; end of node 4
                                    (list (list 'x 'o 'x 'o 'o 'x 'e 'x 'o)	;; x value = 0
                                              (list (list 'x 'o 'x 'o 'o 'x 'x 'x 'o)	;; x value = 0
					      ) ;; end of node 11
				    ) ;; end of node 5
			  ) ;; end of node 1

			  ;; node 2, child of root	
			  (list (list 'x 'o 'x 'o 'o 'e 'x 'x 'e)	;; x value = -10
                                    ;; node 6, child of node 2
                                    (list (list 'x 'o 'x 'o 'o 'o 'x 'x 'e)	;; x value = -10
				    ) ;; end of node 6
                                    ;; node 7, child of node 2
                                    (list (list 'x 'o 'x 'o 'o 'e 'x 'x 'o)	;; x value = 0
			  ...
			  (list (list 'x 'o 'x 'o 'o 'e 'e 'x 'x)	;; x value = 0
                                    ;; node 8, child of node 3
                                    (list (list 'x 'o 'x 'o 'o 'o 'e 'x 'x)	;; x value = -10
				    ) ;; end of node 8
                                    ;; node 9, child of node 3
                                    (list (list 'x 'o 'x 'o 'o 'e 'o 'x 'x)	;; x value = + 10
                                              ;; node 10, child of node 4
                                              (list (list 'x 'o 'x 'o 'o 'x 'o 'x 'x)	;; x value = +10
					      ) ;; end of node 10
                                    ) ;; end of node 9
